...
package_name = 'yolov8_seg_track_ros2'
...
setup(
    ...
    zip_safe=True,
    maintainer='cogmodel',
    maintainer_email='omatykina@mail.ru',
    description='TODO: Package description',
    license='TODO: License declaration',
    tests_require=['pytest'],
    entry_points={
        'console_scripts': [
            'yolov8_seg_node = yolov8_seg_track_ros2.yolov8_seg_node:main',
            'visualizer_node = yolov8_seg_track_ros2.visualizer_node:main',
